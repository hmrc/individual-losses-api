...
package v6.lossClaims.delete.def1.model.request
...
case class Def1_DeleteLossClaimRequestData(nino: Nino, claimId: ClaimId, taxYearClaimedFor: TaxYear) extends DeleteLossClaimRequestData {
