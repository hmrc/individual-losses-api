...
import v3.controllers.validators.resolvers.ResolveBFLossId
...
class RetrieveBFLossValidatorFactory {
  ...
  def validator(nino: String, lossId: String): Validator[RetrieveBFLossRequestData] =
    new Validator[RetrieveBFLossRequestData] {
      ...
      def validate: Validated[Seq[MtdError], RetrieveBFLossRequestData] = {
        ...
        ).mapN(RetrieveBFLossRequestData)
      }
