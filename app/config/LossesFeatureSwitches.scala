...
import api.config.{SharedAppConfig, FeatureSwitches}

/** API-specific feature switches.
  */
case class LossesFeatureSwitches(protected val featureSwitchConfig: Configuration) extends FeatureSwitches {
