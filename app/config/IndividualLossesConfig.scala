...
/** Put API-specific config here...
  */
@Singleton
class IndividualLossesConfig @Inject() (config: ServicesConfig, configuration: Configuration) {
  ...
  def featureSwitches: FeatureSwitches = IndividualLossesFeatureSwitches(featureSwitchConfig)
