...
import v2.services.{RetrieveBFLossOutcome, RetrieveBFLossService}
...
trait MockRetrieveBFLossService extends MockFactory {
  ...
  object MockRetrieveBFLossService {
    def retrieve[A](retrieveBFLossRequest: RetrieveBFLossRequest): CallHandler[Future[RetrieveBFLossOutcome]] = {
      (mockRetrieveBFLossService.retrieveBFLoss(_: RetrieveBFLossRequest)(_: HeaderCarrier, _: ExecutionContext, _:UserRequest[A]))
