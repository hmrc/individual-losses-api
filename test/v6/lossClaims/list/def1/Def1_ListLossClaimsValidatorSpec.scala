...
import v6.lossClaims.list.ListLossClaimsValidatorFactory
...
class Def1_ListLossClaimsValidatorSpec extends UnitSpec {
  ...
  "running validation" should {
    "return the parsed request data" when {
      ...
      "given a valid request with no parameters" in {
        ...
        result shouldBe Right(
          Def1_ListLossClaimsRequestData(parsedNino, parsedTaxYear, None, None, None)
        )
      }
    }
