...
import v3.mocks.services.{MockAuditService, MockEnrolmentsAuthService, MockListBFLossesService, MockMtdIdLookupService}
import v3.models.downstream.{BFLossId, ListBFLossHateoasData, ListBFLossesResponse}
...
class ListBFLossesControllerSpec
  ...
  val request: ListBFLossesRequest = ListBFLossesRequest(Nino(nino), Some(DownstreamTaxYear("2019")), None, Some(selfEmploymentId))
