...
import v3.controllers.requestParsers.MockCreateLossClaimRequestParser
...
import v3.services.MockCreateLossClaimService

import scala.concurrent.ExecutionContext.Implicits.global
import scala.concurrent.Future

class CreateLossClaimControllerSpecRequest
    extends ControllerBaseSpec
    with ControllerTestRunner
    with MockCreateLossClaimService
    with MockCreateLossClaimRequestParser
  ...
  private trait Test extends ControllerTest with AuditEventChecking {
    ...
    private val controller = new CreateLossClaimController(
      ...
      parser = mockCreateLossClaimRequestParser,
