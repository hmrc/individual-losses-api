...
import v3.controllers.requestParsers.validators.MockDeleteBFLossValidator
import v3.models.request.deleteBFLosses.{DeleteBFLossRawData, DeleteBFLossRequest}

class DeleteBFLossRequestParserSpec extends UnitSpec {
  ...
  trait Test extends MockDeleteBFLossValidator {
    lazy val parser = new DeleteBFLossRequestParser(mockValidator)
  }
