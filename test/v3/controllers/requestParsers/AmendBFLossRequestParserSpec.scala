...
import v3.controllers.requestParsers.validators.MockAmendBFLossValidator
import v3.models.request.amendBFLosses.{AmendBFLossRawData, AmendBFLossRequest, AmendBFLossRequestBody}

class AmendBFLossRequestParserSpec extends UnitSpec {
  ...
  trait Test extends MockAmendBFLossValidator {
    lazy val parser = new AmendBFLossRequestParser(mockValidator)
  }
