...
import v3.controllers.requestParsers.validators.MockDeleteLossClaimValidator
import v3.models.request.deleteLossClaim.{DeleteLossClaimRawData, DeleteLossClaimRequest}

class DeleteLossClaimRequestParserSpec extends UnitSpec {
  ...
  trait Test extends MockDeleteLossClaimValidator {
    lazy val parser = new DeleteLossClaimRequestParser(mockValidator)
  }
