...
import v3.controllers.requestParsers.validators.MockAmendLossClaimTypeValidator
...
class AmendLossClaimTypeRequestParserSpec extends UnitSpec {
  ...
  trait Test extends MockAmendLossClaimTypeValidator {
    lazy val parser = new AmendLossClaimTypeRequestParser(mockValidator)
  }
