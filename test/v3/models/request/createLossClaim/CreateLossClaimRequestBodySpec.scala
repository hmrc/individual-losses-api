...
class CreateLossClaimRequestBodySpec extends UnitSpec with JsonErrorValidators {
  ...
  val lossClaimSelfEmployment: CreateLossClaimRequestBody = createLossClaim.CreateLossClaimRequestBody(
  ...
  val lossClaimUkPropertyNonFhl: CreateLossClaimRequestBody = createLossClaim.CreateLossClaimRequestBody(
    taxYearClaimedFor = "2019-20",
  ...
  val lossClaimForeignProperty: CreateLossClaimRequestBody = createLossClaim.CreateLossClaimRequestBody(
    taxYearClaimedFor = "2019-20",
