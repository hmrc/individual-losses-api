...
class AmendBFLossValidatorFactorySpec extends UnitSpec {
    ...
    "return the parsed domain object" when {
      "given a valid request" in {
        ...
        result shouldBe Right(
          AmendBFLossRequestData(parsedNino, parsedLossId, AmendBFLossRequestBody(3.0))
        )
      }
      ...
      "given a valid nino and the minimum loss amount" in {
        ...
        result shouldBe Right(
          AmendBFLossRequestData(parsedNino, parsedLossId, AmendBFLossRequestBody(0.0))
        )
      }
      ...
      "given a valid nino and the maximum loss amount" in {
        ...
        result shouldBe Right(
          AmendBFLossRequestData(parsedNino, parsedLossId, AmendBFLossRequestBody(99999999999.99))
        )
      }
    }
