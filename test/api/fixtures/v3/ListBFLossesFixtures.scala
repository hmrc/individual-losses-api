...
object ListBFLossesFixtures {
  ...
  def singleBFLossesResponseModel(taxYear: String): ListBFLossesResponse[ListBFLossesItem] = ListBFLossesResponse(
    List(listBFLossesModel(taxYear))
  )

  val multipleBFLossesResponseModel: ListBFLossesResponse[ListBFLossesItem] = ListBFLossesResponse(
    List(
