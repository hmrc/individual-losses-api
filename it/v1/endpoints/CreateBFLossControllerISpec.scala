...
class CreateBFLossControllerISpec extends IntegrationBaseSpec {
  ...
  "Calling the create BFLoss endpoint" should {
    ...
    "return 500 (Internal Server Error)" when {
      ...
      createErrorTest(Status.BAD_REQUEST, "INVALID_XXX", Status.INTERNAL_SERVER_ERROR, DownstreamError)
    ...
    "return 400 (Bad Request)" when {
      ...
      createBFLossValidationErrorTest("AA123456A",
        generateBFLoss(Some("selfEmploymentId"), "uk-other-property", "2019-20", lossAmount), Status.BAD_REQUEST, RuleSelfEmploymentId)
      createBFLossValidationErrorTest("AA123456A",
