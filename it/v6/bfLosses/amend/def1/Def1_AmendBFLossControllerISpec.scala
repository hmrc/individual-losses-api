...
class Def1_AmendBFLossControllerISpec extends IntegrationBaseSpec {
  ...
  private trait Test {
    ...
    val taxYear                 = "2020-21"
    val taxYearDownstreamFormat = "20-21"
    ...
    def url: String    = s"/$nino/brought-forward-losses/$lossId/change-loss-amount/$taxYear"
    def ifsUrl: String = s"/income-tax/brought-forward-losses/$nino/$taxYearDownstreamFormat/$lossId"
    ...
    "return errors as per the spec" when {
      "validation error occurs" when {
        def validationErrorTest(requestNino: String,
                                ...
                                requestTaxYearDownstreamFormat: String,
                                requestBody: JsValue,
                                expectedStatus: Int,
          ...
          s"validation fails with ${expectedBody.code} error" in new Test {
            ...
            override val taxYearDownstreamFormat: String = requestTaxYearDownstreamFormat
        ...
        val input = List(
          ("AA1123A", "XAIS12345678910", "2020-21", "20-21", requestJson, BAD_REQUEST, NinoFormatError),
          ("AA123456A", "XAIS1234dfxgchjbn5678910", "2020-21", "20-21", requestJson, BAD_REQUEST, LossIdFormatError),
          ("AA123456A", "XAIS12345678910", "2020-2021", "20-21", requestJson, BAD_REQUEST, TaxYearFormatError),
          ("AA123456A", "XAIS12345678910", "2020-21", "20-21", invalidRequestJson, BAD_REQUEST, ValueFormatError.withPath("/lossAmount")),
          ("AA123456A", "XAIS12345678910", "2020-21", "20-21", JsObject.empty, BAD_REQUEST, RuleIncorrectOrEmptyBodyError)
        )
