...
class Def1_DeleteLossClaimItsdSpec extends IntegrationBaseSpec {
  ...
  private trait Test {
    ...
    def hipUrl: String = s"/itsd/income-sources/claims-for-relief/$nino/$claimId?taxYear=$downstreamTaxYear"
  ...
  "Calling the delete Loss Claim endpoint" should {
    ...
    "handle errors according to spec" when {
      ...
      serviceErrorTest(BAD_REQUEST, "1117", NOT_FOUND, TaxYearFormatError)
