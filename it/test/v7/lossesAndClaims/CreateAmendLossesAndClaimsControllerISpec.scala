...
class CreateAmendLossesAndClaimsControllerISpec extends IntegrationBaseSpec {
  ...
  "Calling the create amend losses and claims endpoint" should {
    ...
    "downstream service error" when {
      ...
      createErrorTest(UNPROCESSABLE_ENTITY, "1253", BAD_REQUEST, RuleMissingPreferenceOrderError)
      createErrorTest(UNPROCESSABLE_ENTITY, "1254", BAD_REQUEST, RuleCarryForwardAndTerminalLossNotAllowedError)
      createErrorTest(UNPROCESSABLE_ENTITY, "1262", BAD_REQUEST, RuleCarryBackClaimError)
      createErrorTest(UNPROCESSABLE_ENTITY, "4200", BAD_REQUEST, RuleOutsideAmendmentWindow)
      createErrorTest(NOT_IMPLEMENTED, "5000", INTERNAL_SERVER_ERROR, InternalError)
