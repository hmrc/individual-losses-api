...
package v5.bfLosses.retrieve.def2
...
class Def2_RetrieveBFLossControllerISpec extends IntegrationBaseSpec {

  val lossAmount        = 531.99
  val businessId        = "XKIS00000000988"
  val lastModified      = "2018-07-13T12:13:48.763Z"
  val taxYear           = "2025-26"
  val downstreamTaxYear = "2026"
  ...
  private trait Test {
    ...
    val responseJson: JsValue = Json.parse(
      s"""
         ...
         |    "def2Field":"discriminator for illustration purposes"
         |}
      """.stripMargin)
